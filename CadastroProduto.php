...
<html lang="en">
  ...
  <body>
    <div class="container">
	<h1 class="text-center bg-primary text-white texto2">CADASTRO DE FORNECEDOR</h1>
	<br>
		<div class="row">
			<div class="col">
			...
			<div class="elemento">
				<form action="#" method="POST">
				  ...
				  <div class="mb-3">
					<label for="cpf" class="form-label">Tipo de produto:</label>
				  ...
				  <div class="mb-3">
					<label for="endereco" class="form-label">Fornecedor         </label>
				  ...
				  <div class="mb-3">
					<label for="tel" class="form-label">Quantidade         </label>
