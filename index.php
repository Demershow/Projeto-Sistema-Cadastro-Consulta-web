  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Cadastro de clientes DdDEV</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <form action="#" method="POST">
	  <div class="modal-body" id="modal-pp">
			<div class="mb-3 row">
				<label for="staticEmail" class="col-sm-2 col-form-label">Úsuario:</label>
				<div class="col-sm-10">
